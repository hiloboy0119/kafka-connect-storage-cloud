...
public class DeltaFormat implements Format<S3SinkConnectorConfig, String> {
  private final S3Storage storage;
  private final AvroData avroData;

  public DeltaFormat(S3Storage storage) {
  ...
  public RecordWriterProvider<S3SinkConnectorConfig> getRecordWriterProvider() {
    return new DeltaRecordWriterProvider(storage, avroData);
  }
